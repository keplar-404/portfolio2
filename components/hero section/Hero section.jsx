...
function Hero() {
  return (
    <>
      ...
      >
        <div className="w-2/3">
          <p className="sm:text-xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl txt">Hy! I AM</p>
        ...
        <div className="h-screen md:w-1/3 lg:w-5/12 xl:w-5/12 2xl:w-5/12  flex justify-end items-center">
          <img src="./me.png" alt="pic" className="w-auto sm:h-64 md:h-80 lg:h-96 xl:h-96 2xl:h-2/3" />
          {/* code png */}
          <div className="absolute">
          <img src="./code.png" alt="code" className=" 
          ...
          {/* monotor png */}
          <div className="absolute">
          <img src="./monitor.png" alt="code" className=" w-auto sm:h-5 md:h-6 lg:h-8 xl:h-9 2xl:h-11 sm:mb-32 md:mb-44 lg:mb-52 xl:mb-44 2xl:mb-52 2xl:-mt-24 sm:mr-32 md:mr-44 lg:mr-60 xl:mr-60 2xl:mr-72" />
          </div>

{/* codepan png */}
<div className="absolute">
          <img src="./codepan.png" alt="code" className=" w-auto sm:h-6 md:h-7 lg:h-9 xl:h-10 2xl:h-11 
...
{/* git png */}
<div className="absolute">
          <img src="./git.png" alt="code" className=" w-auto 
...
{/* vs png */}
<div className="absolute">
          <img src="./vs.png" alt="code" className=" w-auto 
          sm:h-7 md:h-8 lg:h-10 xl:h-12 2xl:h-16 
